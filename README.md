...
В данном проекте были реализованные следующие основные понятие: __ассемблирование команд__ в _машинный код_, симуляция работы __центрального обрабатывающего устройства__ (__CPU__), а      __дизассемблирование__ машинного кода обратно в ассемблерные команды.  
                :one::one::one::zero::zero::one::zero::zero:
...
- [ ] _Disassembler_
    ...
    - [ ] __Биективный__ дизассемблинг.
        - [ ] Получать из кодов меток сами метки. 
...
```C++
pop     ; просто достает число из stack'a и никуда не записывает
