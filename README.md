...
- [ ] _Disassembler_
    - [ ] Обработка __закодированных команд__.
    - [ ] Дизассемблирование кодов команд в __коды__.
    - [ ] Обеспечить работу с __различными__ типами данных.
    - [ ] __Биективный__ дизассемблинг.
    - [ ] Поддержка __разных__ типов данных. 
- [ ] _CPU_
